...
namespace MK.Glow.Legacy.Editor
{
    ...
    {
        //Behaviors
        private SerializedProperty _showEditorMainBehavior, _showEditorBloomBehavior, _showEditorLensSurfaceBehavior,
                                   _showEditorLensFlareBehavior, _showEditorGlareBehavior;

        //Main
        private SerializedProperty _allowGeometryShaders, 
                                   _allowComputeShaders,
                                   _renderPriority, 
                                   _debugView, _quality, 
                                   _antiFlickerMode, _workflow,
                                   _selectiveRenderLayerMask,
                                   _anamorphicRatio, 
                                   _lumaScale,
                                   _blooming;

        //Bloom
        private SerializedProperty _bloomThreshold, _bloomScattering, _bloomIntensity;

        //Lens Surface
        private SerializedProperty _allowLensSurface,
                                   _lensSurfaceDirtTexture,
                                   _lensSurfaceDirtIntensity,
                                   _lensSurfaceDiffractionTexture,
        ...
        private SerializedProperty _allowLensFlare,
                                   _lensFlareStyle,
                                   _lensFlareGhostFade,
                                   _lensFlareGhostIntensity,
                                   _lensFlareThreshold,
                                   _lensFlareScattering,
                                   _lensFlareColorRamp,
                                   _lensFlareChromaticAberration,
                                   _lensFlareGhostCount,
                                   _lensFlareGhostDispersal,
                                   _lensFlareHaloFade,
                                   _lensFlareHaloIntensity,
                                   _lensFlareHaloSize;
        ...
        private SerializedProperty _allowGlare,
                                   ...
                                   _glareSample0Intensity,
                                   _glareSample0Angle,
                                   _glareSample0Offset,
                                   _glareSample1Scattering,
                                   _glareSample1Intensity,
                                   _glareSample1Angle,
                                   _glareSample1Offset,
                                   _glareSample2Scattering,
                                   _glareSample2Intensity,
                                   _glareSample2Angle,
                                   _glareSample2Offset,
                                   _glareSample3Scattering,
                                   _glareSample3Intensity,
                                   _glareSample3Angle,
                                   _glareSample3Offset;
